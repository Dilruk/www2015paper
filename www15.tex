...
While such systems demonstrate acceptable performance, they suffer from a number of drawbacks, most notable of which are requiring a priori knowledge of relevant keywords and brittleness in adapting to new languages or event types. 
This paper extends such approaches by introducing a technique for modeling temporal patterns exhibited by keywords experiencing bursts and by building a classifier that can identify these bursting keywords from Twitter's public sample stream.
